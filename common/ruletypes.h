...
RULE_INT(Network, MaxOutstandingResends, 5)
RULE_INT(Network, MaxResendsBeforeDisconnect, 5)
RULE_INT(Network, HoldTimeMS, 50)
RULE_INT(Network, HoldSizeBytes, 512)
RULE_REAL(Network, TicRateHz, 60.0)
